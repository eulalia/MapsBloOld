...
NucleaReactors <- read_html("https://en.wikipedia.org/wiki/List_of_commercial_nuclear_reactors")
...
#Country: h2#id
#PlantName: tbody#td rowspan ="1" 
#NReactors: The description of the product.
